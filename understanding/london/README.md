...
historical sites, a timeline of selected events and a table of English and British dynasties.
...
| VI | Civil War, Fire and Finance — Politics, buildings and finance reshaped London | `06-civil-war-fire-and-finance.html` |
...
├── markdown/                  # the same text as Markdown
...
matter. Useful if you want to re-import it into another documentation platform.
The HTML edition uses local assets; the Markdown home page currently references an external Unsplash image.

`markdown/` 目录是同样内容的英文 Markdown，每页一个文件并带 front matter，可用于重新导入其他文档平台。
...
- **Text** — an English translation of the Chinese reading edition 《读懂伦敦》. Translations of linked sources are
